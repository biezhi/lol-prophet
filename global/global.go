...
type (
	...
	BlockUserScore struct {
		SummonerID   int64  `json:"summonerID"`
		SummonerName string `json:"summonerName"`
		Reason       string `json:"reason"`
	}
	SummonerIDMapScore struct {
		SelfTeam   []UserScore      `json:"selfTeam"`
		EnemyTeam  []UserScore      `json:"enemyTeam"`
		BlackUsers []BlockUserScore `json:"blackUsers"`
	}
...
func SetSummonerIDList(info SummonerIDMapScore) {
	SummonerIDListScore = info
}
